...
struct Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_AbilitySystem_AttributeSet_PTCharacter_AttributeSet_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPTCharacter_AttributeSet, UPTCharacter_AttributeSet::StaticClass, TEXT("UPTCharacter_AttributeSet"), &Z_Registration_Info_UClass_UPTCharacter_AttributeSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPTCharacter_AttributeSet), 1371717203U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_AbilitySystem_AttributeSet_PTCharacter_AttributeSet_h_4040418746(TEXT("/Script/ProjectPT"),
