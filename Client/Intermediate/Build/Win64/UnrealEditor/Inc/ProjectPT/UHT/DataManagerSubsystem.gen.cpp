...
struct Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_Table_DataManagerSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDataManagerSubsystem, UDataManagerSubsystem::StaticClass, TEXT("UDataManagerSubsystem"), &Z_Registration_Info_UClass_UDataManagerSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataManagerSubsystem), 2107783070U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_Table_DataManagerSubsystem_h_2346035031(TEXT("/Script/ProjectPT"),
