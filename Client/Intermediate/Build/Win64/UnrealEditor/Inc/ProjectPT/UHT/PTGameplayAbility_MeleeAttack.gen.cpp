...
struct Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_AbilitySystem_Abilities_PTGameplayAbility_MeleeAttack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPTGameplayAbility_MeleeAttack, UPTGameplayAbility_MeleeAttack::StaticClass, TEXT("UPTGameplayAbility_MeleeAttack"), &Z_Registration_Info_UClass_UPTGameplayAbility_MeleeAttack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPTGameplayAbility_MeleeAttack), 1346440363U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_AbilitySystem_Abilities_PTGameplayAbility_MeleeAttack_h_3159671214(TEXT("/Script/ProjectPT"),
