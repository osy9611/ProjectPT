...
// Begin Class UPTHeroComponent Function GetSkeletonMeshSocketPos
struct Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics
{
	struct PTHeroComponent_eventGetSkeletonMeshSocketPos_Parms
	{
		FName SocketName;
		FVector ReturnValue;
	};
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::NewProp_SocketName = { "SocketName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PTHeroComponent_eventGetSkeletonMeshSocketPos_Parms, SocketName), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PTHeroComponent_eventGetSkeletonMeshSocketPos_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::NewProp_SocketName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPTHeroComponent, nullptr, "GetSkeletonMeshSocketPos", nullptr, nullptr, Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::PTHeroComponent_eventGetSkeletonMeshSocketPos_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::PTHeroComponent_eventGetSkeletonMeshSocketPos_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UPTHeroComponent::execGetSkeletonMeshSocketPos)
{
...
// End Class UPTHeroComponent Function GetSkeletonMeshSocketPos

// Begin Class UPTHeroComponent Function GetSkeletonMeshSocketTransform
struct Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics
{
	struct PTHeroComponent_eventGetSkeletonMeshSocketTransform_Parms
	{
		FName SocketName;
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::NewProp_SocketName = { "SocketName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PTHeroComponent_eventGetSkeletonMeshSocketTransform_Parms, SocketName), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PTHeroComponent_eventGetSkeletonMeshSocketTransform_Parms, ReturnValue), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::NewProp_SocketName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPTHeroComponent, nullptr, "GetSkeletonMeshSocketTransform", nullptr, nullptr, Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::PTHeroComponent_eventGetSkeletonMeshSocketTransform_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::PTHeroComponent_eventGetSkeletonMeshSocketTransform_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UPTHeroComponent::execGetSkeletonMeshSocketTransform)
{
	P_GET_PROPERTY(FNameProperty,Z_Param_SocketName);
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class UPTHeroComponent Function GetSkeletonMeshSocketTransform
...
void UPTHeroComponent::StaticRegisterNativesUPTHeroComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "GetSkeletonMeshSocketPos", &UPTHeroComponent::execGetSkeletonMeshSocketPos },
		{ "GetSkeletonMeshSocketTransform", &UPTHeroComponent::execGetSkeletonMeshSocketTransform },
	};
...
struct Z_Construct_UClass_UPTHeroComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketPos, "GetSkeletonMeshSocketPos" }, // 302887015
		{ &Z_Construct_UFunction_UPTHeroComponent_GetSkeletonMeshSocketTransform, "GetSkeletonMeshSocketTransform" }, // 875976988
	};
...
struct Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_Character_PTHeroComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPTHeroComponent, UPTHeroComponent::StaticClass, TEXT("UPTHeroComponent"), &Z_Registration_Info_UClass_UPTHeroComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPTHeroComponent), 3154141692U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Client_Source_ProjectPT_Character_PTHeroComponent_h_3625299114(TEXT("/Script/ProjectPT"),
